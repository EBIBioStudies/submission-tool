...
const filterList = () =>
{
  ...
  filteredListItems.value =  SearchLinks(thisLink.value?.url).filter(item =>
    item.toLowerCase().includes(thisLink.value?.url.toLowerCase())
  );
...
<template>
  <div class="dropdown">
    <div class="input-group">
      <input
        type="text"
        class="form-control text-primary form-control-sm dropdown-input"
        :class="props?.class"
