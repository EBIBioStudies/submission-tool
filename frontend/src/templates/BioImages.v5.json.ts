...
export default {
  ...
  'sectionType': {
    ...
    'banner': {
      ...
      'contactUs': {
        'text': 'If your submission contains complex REMBI section associations that do not fit this form, please send us an email at email bioimage-archive@ebi.ac.uk',
      },
    },
    'fieldTypes': [
      {
        ...
        'fieldTypes': [
          {
            ...
            'helpContextual': {
              'description': 'A short, representative name for this Biosample section. You will use it in the Associations table of the Study Components REMBI section.',
              'examples': [
                'Biosample 1',
                'Biosample 2',
              ],
        ...
        'fieldTypes': [
          {
            ...
            'helpContextual': {
              'description': 'A short, representative name for this Specimen section. You will use it in the Associations table of the Study Components REMBI section.',
              'examples': [
                'Specimen 1',
                'Specimen 2',
              ],
        ...
        'fieldTypes': [
          {
            ...
            'helpContextual': {
              'description': 'A short, representative name for this Image acquisition section. You will use it in the Associations table of the Study Components REMBI section.',
              'examples': [
                'Image acquisition 1',
                'Image acquisition 2',
              ],
        ...
        'fieldTypes': [
          {
            ...
            'helpContextual': {
              'description': 'A short, representative name for this Image correlation section. You will use it in the Associations table of the Study Components REMBI section.',
              'examples': [
                'Image correlation 1',
                'Image correlation 2',
              ],
        ...
        'fieldTypes': [
          {
            ...
            'helpContextual': {
              'description': 'A short, representative name for this Image analysis section. You will use it in the Associations table of the Study Components REMBI section.',
              'examples': [
                'Image analysis 1',
                'Image analysis 2',
              ],
